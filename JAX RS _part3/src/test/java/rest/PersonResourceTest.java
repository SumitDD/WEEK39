...
public class PersonResourceTest {
    ...
    public void setUp() {
        ...
        p1 = new Person("Chris", "Wegner", "8888");
        p2 = new Person("Lukas", "Bang", "4444");
        try {
    ...
    public void testAddPerson() {
        given()
                ...
                .body(new PersonDTO("Jon", "Snow", "7896"))
                .when()
                .post("xxx/insertPerson")
                .then()
                .body("fName", equalTo("Jon"))
                .body("lName", equalTo("Snow"))
                .body("phone", equalTo("7896"));

    }

    @Test
    public void testEditPerson() {
        Person person = new Person("Sumit", "Dey", "22630");
        long id = 14;
        person.setId(id);
    ...
    public void negativeTestDeletePerson() {
        Person person = new Person("Ole", "Larsen", "555555");
        long fakeId = 55;
        person.setId(fakeId);
        PersonDTO personDTO = new PersonDTO(person);
